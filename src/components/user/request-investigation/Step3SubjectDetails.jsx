...
const Step3SubjectDetails = forwardRef(({ formData, handleInputChange }, ref) => {
  ...
  const runValidate = (name, value) => {
    ...
    if (name === 'subjectContact') return value ? validatePhone(value) : '';
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input type="text" name="subjectEntityName" placeholder="Enter Name" style={fieldStyle} className={fieldClass} value={formData.subjectEntityName || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)} />
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input type="tel" name="subjectContact" placeholder="Phone number" style={fieldStyle} className={fieldClass} value={formData.subjectContact || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)} />
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input type="email" name="subjectEmail" placeholder="Enter Email ID" style={fieldStyle} className={fieldClass} value={formData.subjectEmail || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)} />
        </div>
      ...
      <div className="space-y-2">
        ...
        <input type="text" name="subjectPincode" placeholder="Enter Pincode" style={{ ...fieldStyle, paddingLeft: '16px' }} className={fieldClass} value={formData.subjectPincode || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)} />
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input type="text" name="subjectCity" placeholder="Enter City / Village" style={fieldStyle} className={fieldClass} value={formData.subjectCity || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)} />
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 z-10" size={16} />
          <input type="text" name="subjectState" placeholder="Enter State" style={fieldStyle} className={fieldClass} value={formData.subjectState || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)} />
        </div>
      ...
      <div className="space-y-2 md:col-span-2 lg:col-span-3">
        ...
        <select name="relationshipToSubject" style={selectStyleNoPad} className={fieldClass} value={formData.relationshipToSubject || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)}>
      ...
      <div className="space-y-2 md:col-span-2 lg:col-span-3">
        ...
        <select name="subjectType" style={selectStyleNoPad} className={fieldClass} value={formData.subjectType || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)}>

...
import { validateSelect, validateAddress, validateOnlyCharacters } from '../../../hooks/validation';
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <select name="locationType" style={fieldStyle} className={fieldClass} value={formData.locationType || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)}>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 z-10" size={16} />
          <input type="text" name="locationState" placeholder="Enter State" style={fieldStyle} className={fieldClass} value={formData.locationState || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)} />
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 z-10" size={16} />
          <input type="text" name="locationCity" placeholder="Enter City" style={fieldStyle} className={fieldClass} value={formData.locationCity || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)} />
        </div>
      ...
      <div className="md:col-span-3 space-y-2">
        ...
        <div className="relative">
          <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 z-10" size={16} />
          <input type="text" name="locationAddress" placeholder="eg- build 12, flat- 4, locality, area, landmark" style={fieldStyle} className={fieldClass} value={formData.locationAddress || ''} onChange={handleChange} onBlur={e => validate(e.target.name, e.target.value)} />
        </div>

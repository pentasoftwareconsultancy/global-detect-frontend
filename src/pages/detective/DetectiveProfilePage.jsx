...
const lbl = { fontSize: '13px', color: 'white', marginBottom: '6px'  };
    ...
    <div className="bg-[#121F27] text-white min-h-screen px-3 sm:px-6 py-4 sm:py-6 montserrat">
      ...
      <div style={card}>
        <div className="flex items-center gap-4">
          <div style={{ width: '64px', height: '64px', borderRadius: '50%', background: '#FF4959', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', fontWeight: '700', color: '#fff', flexShrink: 0 }}>
            {getInitials(name)}
          </div>
          <div>

...
const AdminBlogPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#121F27] text-white p-6 font-[Montserrat]">
      ...
      {/* Search + Filter */}
      <div className="bg-[#1A2832] border border-white/5 rounded-xl px-4 py-3 flex items-center justify-between mb-4">
        ...
        <select
          ...
          className="bg-[#1A2832] border border-white/10 text-sm text-white rounded-lg px-3 py-1.5 outline-none ml-4"
        >
      ...
      <div className="space-y-4">
        {filtered.map(blog => (
          <div key={blog.id} className="bg-[#1A2832] border border-white/5 rounded-xl p-5 flex gap-5 items-start">

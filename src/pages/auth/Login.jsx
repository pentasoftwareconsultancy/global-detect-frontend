          ...
          <form className="space-y-3 mt-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input type="text" name="emailOrPhone" placeholder="Enter your email / phone number" value={formData.emailOrPhone} onChange={handleInputChange} disabled={loading} style={inputStyle} className={inputClass} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  className="w-full border border-white/60 pr-11 text-white bg-transparent outline-none focus:border-white placeholder:font-montserrat placeholder:font-medium placeholder:text-[14px] placeholder:leading-[21px] placeholder:text-white/60 disabled:opacity-50"
                />
